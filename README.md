...
The UHG encoder and UHG layer feature-map paths now use explicit `TangentSpaceLinear` adapters for remaining Euclidean linear maps, making tangent-space boundaries visible before deeper manifold-native layer refactors.
