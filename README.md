...
The UHG encoder, UHG layer feature-map paths, and alignment graph projection fallback now use explicit `TangentSpaceLinear` adapters for remaining Euclidean linear maps, making tangent-space boundaries visible before deeper manifold-native layer refactors.
